...
const About = () => (
    <section id='about' className='q-contain scroll-mt-24'>
        <div className='mx-auto'>
            ...
            <div className='max-w-3xl mx-auto grid md:grid-cols-[1fr_auto] gap-6 mt-16 md:gap-16'>
                <div className='text-lg text-primary-text/80'>
                    ...
                    <p className='mt-6'>
                        ...
                        latest web dev trends. Let's connect and build something amazing together!
                    </p>
